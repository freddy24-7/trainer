    ...
    return (
        ...
        >
            ...
            <div className="md:hidden flex items-center w-min ">
                ...
                >
                    {menuOpen ? <FiX size={24}/> : <FiMenu size={24}/>} {/* Toggling between FiMenu and FiX */}
                </Button>
            </div>
            ...
            {menuOpen && (
                <div className="flex flex-col items-center bg-brandcolor w-auto py-4 mt-12">
                    ...
                    <Button as={Link} href='/login' variant='bordered' className='text-white w-auto my-2'>Login</Button>
                    <Button as={Link} href='/register' variant='bordered'
                            className='text-white w-auto my-2'>Register</Button>
                    <Button
                        variant="bordered"
